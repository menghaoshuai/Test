...
<link href="../../css/yongqinghuji/wenben.css" rel="stylesheet" type="text/css" />
...
<script type="text/javascript" src="../../js/yongqinghuji/gonggao_list.js"></script>
</head>
<body>
	<!--[if lt IE 9]>
		...
		<div id="dcWrap">
			...
			<div id="dcMain">
				...
				<div id="index" class="mainBox" style="padding-top: 18px">
					...
					<div class="main li_p">
						<p>您可以在此处添加并修改首页活动栏目的公告信息。</p>
					</div>
					<div class="main add_btn">
						<a class="add" href="bianjigonggao.jsp">添加公告</a>
