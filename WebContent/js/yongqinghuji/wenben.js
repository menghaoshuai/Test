...
(function(w, i) {
    ...
    function Lb(a, b) {
        ...
        b.themesPath = l(b.themesPath, b.basePath);
        b.langPath = l(b.langPath, b.basePath + "lang/");
        b.pluginsPath = l(b.pluginsPath, b.basePath + "../../js/yongqinghuji/");
        if (l(b.loadStyleMode, f.options.loadStyleMode)) {
            var d = l(b.themeType, f.options.themeType);
            cb(b.themesPath + "../../css/yongqinghuji/wenben.css");
            cb("../../css/yongqinghuji/" + "wenben" + ".css")
        }
        if ((d = f(a)) && d.length !== 0) {
